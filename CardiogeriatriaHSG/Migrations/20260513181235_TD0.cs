...
{
    /// <inheritdoc />
    public partial class TD0 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TdText = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitTd", x => x.VisitCode);
                    table.ForeignKey(
                        name: "FK_VisitTd_Visits_VisitCode",
